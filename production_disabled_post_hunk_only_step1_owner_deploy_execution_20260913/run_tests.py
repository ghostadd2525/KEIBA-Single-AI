...
PS1 = ROOT / "02_powershell" / "OWNER_DEPLOY.ps1"
...
def finalize_evidence_and_sums():
    ...
    dest = Path(tempfile.mkdtemp(prefix="step1-sums-")) / "production_disabled_post_hunk_only_step1_owner_deploy_execution_20260913"
...
def main():
    ...
    expect("OWNER_PRODUCTION_STEP1_DEPLOY_APPROVED_UNSET" in (halt.stdout or ""), "ps1_unapproved_reason")
    logs = list(downloads.glob("production_disabled_post_hunk_only_step1_owner_deploy_execution_20260913_output_*.txt"))
