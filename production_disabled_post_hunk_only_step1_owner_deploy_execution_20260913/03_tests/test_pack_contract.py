...
def main() -> int:
    ...
    expect("$env:OWNER_PRODUCTION_STEP1_DEPLOY_APPROVED =" not in ps, "ps1_does_not_assign_approval", failures)
    ...
    expect('RESTART_ARGV = ("systemctl", "restart", RESTART_UNIT)' in stdin, "restart_argv_tuple", failures)
    ...
    expect("WRAPPER_SETS_OWNER_PRODUCTION_STEP1_DEPLOY_APPROVED=NO" in flags, "wrapper_no_set_approval", failures)
    ...
    expect("OWNER_PRODUCTION_STEP1_DEPLOY_APPROVED=1" in ps, "ps1_forwards_owner_one_only", failures)
