...
def finalize_evidence_and_sums():
    ...
    dest = Path(tempfile.mkdtemp(prefix="applyv4-sums-")) / "production_022_apply_owner_execution_v4_20260911"
...
def main():
    ...
    tmp = Path(tempfile.mkdtemp(prefix="applyv4-halt-"))
    ...
    logs = list(downloads.glob("production_022_apply_owner_execution_v4_20260911_output_*.txt"))
