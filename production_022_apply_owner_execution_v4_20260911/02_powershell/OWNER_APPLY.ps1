...
$OutLog = Join-Path $Downloads ('production_022_apply_owner_execution_v4_20260911_output_' + $Stamp + '.txt')
$TimeoutMs = 240000
...
Set-Content -LiteralPath $OutLog -Value 'PRODUCTION_022_APPLY_OWNER_EXECUTION_V4_20260911' -Encoding UTF8
Write-Log ('STARTED=' + (Get-Date -Format 'yyyy-MM-ddTHH:mm:ss'))
Write-Log 'WRAPPER_VERSION=owner_apply_022_v4_20260911'
