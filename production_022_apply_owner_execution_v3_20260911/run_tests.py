...
def finalize_evidence_and_sums():
    ...
    dest = Path(tempfile.mkdtemp(prefix="applyv3-sums-")) / "production_022_apply_owner_execution_v3_20260911"
...
def main():
    ...
    tmp = Path(tempfile.mkdtemp(prefix="applyv3-halt-"))
    ...
    logs = list(downloads.glob("production_022_apply_owner_execution_v3_20260911_output_*.txt"))
