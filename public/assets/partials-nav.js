...
(function () {
  ...
  mount.outerHTML =
    ...
    '<a href="saved.html" data-nav="balance"><svg class="nav-ico" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 19h16M7 16V9M12 16v-7M17 16V6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M6 6.5h3.5M14.5 4h3.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>今月成績</a>' +
