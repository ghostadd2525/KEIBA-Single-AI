...
(function () {
  ...
  mount.outerHTML =
    ...
    '<a href="saved.html" data-nav="saved"><svg class="nav-ico" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="m12 3.5 2.6 5.3 5.9.9-4.2 4.1 1 5.8L12 16.8 6.7 19.6l1-5.8L3.5 9.7l5.9-.9L12 3.5Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" fill="none"/></svg>保存レース</a>' +
    ...
    "</nav>";
  if (window.ExpectShell) ExpectShell.initNav(active);
})();
