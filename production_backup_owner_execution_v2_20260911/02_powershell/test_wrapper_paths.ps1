...
$needed = @('Stop-ProcessTree', 'Get-TaskText', 'Get-WrapperAuditStatus', 'Invoke-TimedProcess', 'Test-OwnerApprovalReady')
...
$g1 = Test-OwnerApprovalReady -Approved '' -Migration022 '' -PredictionRuns ''
...
$g2 = Test-OwnerApprovalReady -Approved '1' -Migration022 '1' -PredictionRuns '0'
Expect ($g2.Ready -eq $false) 'approval_blocks_022'
$g3 = Test-OwnerApprovalReady -Approved '1' -Migration022 '' -PredictionRuns '1'
Expect ($g3.Ready -eq $false) 'approval_blocks_post'
$g4 = Test-OwnerApprovalReady -Approved '1' -Migration022 '' -PredictionRuns '0'
