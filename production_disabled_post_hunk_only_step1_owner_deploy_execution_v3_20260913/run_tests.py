...
def finalize_evidence_and_sums():
    ...
    dest = Path(tempfile.mkdtemp(prefix="step1-sums-")) / "production_disabled_post_hunk_only_step1_owner_deploy_execution_v3_20260913"
...
def main():
    ...
    logs = list(downloads.glob("production_disabled_post_hunk_only_step1_owner_deploy_execution_v3_20260913_output_*.txt"))
