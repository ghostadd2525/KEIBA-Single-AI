...
echo "===== BEGIN OWNER_READ_ONLY_LIVE_SOURCE_CAPTURE_V3 ====="
echo "PACK=production_disabled_post_live_source_capture_readonly_v3_20260912"
...
def emit_judgment(captured: int) -> str:
    ...
    out("NEXT_STEP=INDEPENDENT_REVIEW_OF_READONLY_LIVE_SOURCE_CAPTURE_V3")
    return result
...
def main() -> int:
    ...
    out("KIND=OWNER_READ_ONLY_LIVE_SOURCE_CAPTURE_V3")
...
rc=$?
echo "===== END OWNER_READ_ONLY_LIVE_SOURCE_CAPTURE_V3 ====="
exit "$rc"
