...
PACK=production_disabled_post_live_source_capture_readonly_v3_20260912
KIND=OWNER_READ_ONLY_LIVE_SOURCE_CAPTURE_V3
...
Get-Content -Raw). Production is read-only open only (lstat regular +
O_NOFOLLOW + fstat, must stay under WIN5_ROOT). No Production
file create/change.
...
live-source capture v1 or v2 ZIPs.
...
NEXT_STEP=INDEPENDENT_REVIEW_OF_READONLY_LIVE_SOURCE_CAPTURE_V3
