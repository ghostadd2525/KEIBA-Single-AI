...
$logs = @(Get-ChildItem -LiteralPath (Join-Path $td 'Downloads') -Filter 'production_022_apply_owner_execution_v2_20260911_output_*.txt' -ErrorAction SilentlyContinue)
$fail = 0
