...
KIND=OWNER_READ_ONLY_LIVE_SOURCE_CAPTURE
...
Emit an in-memory tar.gz as base64 on stdout. Windows Tees/saves it.
Production is read-only open only. No Production file create/change.
...
Do not overwrite existing review / live-compare / APPLY / backup ZIPs.
...
NEXT_STEP=INDEPENDENT_REVIEW_OF_READONLY_LIVE_SOURCE_CAPTURE_PACK
