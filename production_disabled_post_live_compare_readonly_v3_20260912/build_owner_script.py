...
# Read-only Production live compare v3. Paste on the Production SSH host.
...
echo "===== BEGIN OWNER_READ_ONLY_LIVE_COMPARE_V3 ====="
echo "PACK=production_disabled_post_live_compare_readonly_v3_20260912"
...
rc=$?
echo "===== END OWNER_READ_ONLY_LIVE_COMPARE_V3 ====="
exit "$rc"
"""
