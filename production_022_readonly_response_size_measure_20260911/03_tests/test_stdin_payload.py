...
STDIN = PS / "owner_measure_stdin.py"
PS1 = PS / "OWNER_MEASURE.ps1"
...
def main() -> int:
    ...
    saved = Path(tempfile.mkdtemp(prefix="measure-payload-")) / "sent_stdin_payload.py"
    ...
    expect("owner_measure_stdin.py" in ps, "ps1_reads_stdin_file", failures)
    ...
    expect("HALT_REASON=OWNER_PRODUCTION_022_MEASURE_APPROVED_UNSET" in out, "python3_dash_unapproved_reason", failures)
