...
$OutLog = Join-Path $Downloads ('production_022_readonly_response_size_measure_20260911_output_' + $Stamp + '.txt')
$TimeoutMs = 180000
...
Set-Content -LiteralPath $OutLog -Value 'PRODUCTION_022_READONLY_RESPONSE_SIZE_MEASURE_20260911' -Encoding UTF8
Write-Log ('STARTED=' + (Get-Date -Format 'yyyy-MM-ddTHH:mm:ss'))
Write-Log 'WRAPPER_VERSION=owner_measure_022_20260911'
