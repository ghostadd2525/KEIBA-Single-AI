...
def finalize_evidence_and_sums():
    ...
    dest = Path(tempfile.mkdtemp(prefix="measure-sums-")) / "production_022_readonly_response_size_measure_20260911"
...
def main():
    ...
    logs = list(downloads.glob("production_022_readonly_response_size_measure_20260911_output_*.txt"))
