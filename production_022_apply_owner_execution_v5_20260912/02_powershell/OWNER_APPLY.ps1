# PowerShell 5.1. Owner-only Production 022 schema APPLY v2.
...
$OutLog = Join-Path $Downloads ('production_022_apply_owner_execution_v5_20260912_output_' + $Stamp + '.txt')
$TimeoutMs = 240000
...
Set-Content -LiteralPath $OutLog -Value 'PRODUCTION_022_APPLY_OWNER_EXECUTION_V5_20260912' -Encoding UTF8
Write-Log ('STARTED=' + (Get-Date -Format 'yyyy-MM-ddTHH:mm:ss'))
Write-Log 'WRAPPER_VERSION=owner_apply_022_v5_20260912'
