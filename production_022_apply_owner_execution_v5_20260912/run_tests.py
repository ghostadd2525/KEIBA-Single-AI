...
def finalize_evidence_and_sums():
    ...
    dest = Path(tempfile.mkdtemp(prefix="applyv5-sums-")) / "production_022_apply_owner_execution_v5_20260912"
...
def main():
    ...
    tmp = Path(tempfile.mkdtemp(prefix="applyv5-halt-"))
    ...
    logs = list(downloads.glob("production_022_apply_owner_execution_v5_20260912_output_*.txt"))
