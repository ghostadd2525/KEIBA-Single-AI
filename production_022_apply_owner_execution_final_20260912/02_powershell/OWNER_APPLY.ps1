...
$OutLog = Join-Path $Downloads ('production_022_apply_owner_execution_final_20260912_output_' + $Stamp + '.txt')
...
Set-Content -LiteralPath $OutLog -Value 'PRODUCTION_022_APPLY_OWNER_EXECUTION_FINAL_20260912' -Encoding UTF8
Write-Log ('STARTED=' + (Get-Date -Format 'yyyy-MM-ddTHH:mm:ss'))
Write-Log 'WRAPPER_VERSION=owner_apply_022_final_20260912'
