...
$needed = @('Stop-ProcessTree', 'Get-TaskText', 'Get-WrapperAuditStatus', 'Get-RemoteApplyState', 'Invoke-TimedProcess', 'Test-OwnerApprovalReady', 'Test-ApplyBackupCanonReady', 'Get-Sha256Hex')
