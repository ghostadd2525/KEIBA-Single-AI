...
$logs = @(Get-ChildItem -LiteralPath (Join-Path $td 'Downloads') -Filter 'production_022_apply_owner_execution_final_20260912_output_*.txt' -ErrorAction SilentlyContinue)
$fail = 0
