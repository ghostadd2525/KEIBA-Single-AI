/**
 * POST /api/v1/user-race-results/settle-pending
 */
...
export async function onRequestPost(context) {
  ...
  const proxied = await aiFetch(context, "/v1/user-race-results/settle-pending", {
    method: "POST",
  ...
  return jsonError("SETTLE_UNAVAILABLE", "settle pending unavailable", 502);
}
