# PowerShell 5.1. Owner-only Production backup v4.
...
$OutLog = Join-Path $Downloads ('production_backup_owner_execution_v4_20260911_output_' + $Stamp + '.txt')
$TimeoutMs = 180000
...
Set-Content -LiteralPath $OutLog -Value 'PRODUCTION_BACKUP_OWNER_EXECUTION_V4_20260911' -Encoding UTF8
Write-Log ('STARTED=' + (Get-Date -Format 'yyyy-MM-ddTHH:mm:ss'))
Write-Log 'WRAPPER_VERSION=owner_backup_v4_20260911'
