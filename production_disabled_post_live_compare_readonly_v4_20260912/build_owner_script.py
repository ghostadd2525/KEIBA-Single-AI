...
# Read-only Production live compare v4. Paste on the Production SSH host.
...
echo "===== BEGIN OWNER_READ_ONLY_LIVE_COMPARE_V4 ====="
echo "PACK=production_disabled_post_live_compare_readonly_v4_20260912"
...
rc=$?
echo "===== END OWNER_READ_ONLY_LIVE_COMPARE_V4 ====="
exit "$rc"
"""
