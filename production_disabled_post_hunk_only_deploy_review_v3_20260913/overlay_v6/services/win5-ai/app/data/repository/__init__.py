...
def _connect_idempotent() -> sqlite3.Connection:
    ...
    journal_mode. Step-1 migrate() also does not change journal_mode.
    WAL enable is a separate step-2 Owner approval, not implicit.
    OperationalError is not swallowed.
    """
    path = db_path()
