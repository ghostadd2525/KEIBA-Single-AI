...
$OwnerPs1 = Join-Path $Here 'OWNER_DEPLOY_V2.ps1'
$fail = 0
...
Expect ($allText.Contains('$env:OWNER_PRODUCTION_STEP1_V2_DEPLOY_APPROVED =') -eq $false) 'wrapper_does_not_set_approval'
...
Expect ($g1.Reason -eq 'OWNER_PRODUCTION_STEP1_V2_DEPLOY_APPROVED_UNSET') 'approval_unset_reason'
