...
Expect ($allText.Contains('APPLY_APPROVAL_NOT_ALLOWED_IN_BACKUP_PACK') -eq $true) 'apply_approval_halt_token'
Expect (($allText.IndexOf('APPLY_APPROVAL_NOT_ALLOWED_IN_BACKUP_PACK') -ge 0) -and ($sshI -gt $allText.IndexOf('APPLY_APPROVAL_NOT_ALLOWED_IN_BACKUP_PACK'))) 'apply_approval_halt_before_ssh'
