...
def main() -> int:
    ...
    saved = Path(tempfile.mkdtemp(prefix="apply-v4-payload-")) / "sent_stdin_payload.py"
    ...
    expect("PACK=production_022_apply_owner_execution_final_20260912" in out, "python3_dash_pack_name", failures)
    expect("APPLY_BACKUP_CANON=PINNED_FRESH_PRODUCTION_BACKUP" in out, "python3_dash_canon_pinned", failures)
