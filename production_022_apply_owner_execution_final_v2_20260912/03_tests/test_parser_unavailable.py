...
def main() -> int:
    ...
    expect("LOCAL_VERIFY=PENDING_WINDOWS_PS51_PARSEFILE" in src, "source_pending_windows_verify", failures)
    expect('print("ALL_PASS" if fail == 0 else "FAIL_COUNT=%d" % fail)' not in src, "source_no_official_all_pass", failures)
