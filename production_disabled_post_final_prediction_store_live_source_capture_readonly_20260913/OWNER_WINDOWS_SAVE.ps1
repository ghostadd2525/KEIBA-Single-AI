# Windows-only save + extract for the read-only final_prediction_store live-source capture.
...
param(
    ...
    [string]$OutDir = (Join-Path $PWD "final_prediction_store_capture_windows"),
    [string]$IdentityFile = "",
    [int]$TimeoutSec = 180
)
