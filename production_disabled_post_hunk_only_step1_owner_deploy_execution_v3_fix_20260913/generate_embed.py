...
FORBIDDEN_REL = "services/win5-ai/app/data/migrations/022_prediction_run_idempotency.sql"
...
def build_tar_gz() -> bytes:
    ...
    with tarfile.open(fileobj=tar_buf, mode="w") as tf:
        ...
        for path in sorted(base.rglob("*")):
            ...
            if rel == FORBIDDEN_REL:
                raise SystemExit("022_SQL_MUST_NOT_BE_CANDIDATE")
...
def main() -> int:
    raw = build_tar_gz()
    if FORBIDDEN_REL.encode("ascii") in raw:
        raise SystemExit("022_SQL_NAME_IN_TAR")
